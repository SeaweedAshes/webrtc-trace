...
class TrendlineEstimator : public DelayIncreaseDetectorInterface {
 public:
  ...
  double accumulated_delay_ms() const { return accumulated_delay_; }
  double smoothed_delay_ms() const { return smoothed_delay_; }
  unsigned window_size() const { return settings_.window_size; }
  size_t delay_hist_size() const { return delay_hist_.size(); }
  double threshold() const { return threshold_; }
  double prev_modified_trend() const { return prev_modified_trend_; }
  double prev_trend() const { return prev_trend_; }
  double time_over_using_ms() const { return time_over_using_; }
  int overuse_counter() const { return overuse_counter_; }
